...
print(PIN1)
coords_from_protein = parsing_coords.coords_dict[PIN1]
...
print(desired_plane_atoms)
def create_pdb_with_coordinates(output_file=f"./Plane/plane_{PIN1}_seg0.pdb"):
