...
PIN = sys.argv[1]
beta_strand_determination(f'./BCEF/{PIN}_BCEF.pdb',f'./{PIN}_BCEF_Beta.pdb')
subprocess.run(['mv', f'{PIN}_BCEF_Beta.pdb', f'./BCEF/{PIN}_BCEF.pdb'], check=True)
subprocess.run(['rm', f'{PIN}_BCEF_Beta.pdb'],check=True)
