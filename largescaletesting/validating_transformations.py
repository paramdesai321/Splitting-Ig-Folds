...
transformed_B = BestFitLine_Projection.forming_strand_from_indices(X.T,Bindices)
print(transformed_B.shape)
transformed_E = BestFitLine_Projection.forming_strand_from_indices(X.T,Eindices)
