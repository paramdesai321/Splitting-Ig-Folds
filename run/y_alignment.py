...
plotting.plot_points_3d(y_aligned_protein_BCEF.T,y=labels.get_Labels(), ax=ax,label='Y Aligned BCEF',color='red')
...
plotting.plot_plane(transformation.transformed_plane,ax=ax,label='Tranformed plane',color='orange')
